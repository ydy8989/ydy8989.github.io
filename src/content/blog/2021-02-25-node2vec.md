...
description: "Netflix Challenge with latent factor model"
pubDate: 2021-02-25
slug: "2021-02-25-node2vec"
categories: ["BOOSTCAMP"]
tags: ["boostcamp", "recommendation"]
disqusId: "https://ydy8989.github.io/2021-02-25-node2vec/"
---
...
![image](/assets/posts/2021-02-25-node2vec-d3824b3f.png){:.center}
...
- 주어진 graph의 각 vertex $u$에 대한 embedding, 즉 vector representation $z_u$는 node embedding의 `output`이다.
	...
	![image](/assets/posts/2021-02-25-node2vec-aec252be.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-348c125d.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-2efd7feb.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-ed5185de.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-13dd611b.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-61f45d4e.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-c7ea8b2f.png){:.center}
...
- Node2Vec은 `2차 치우친 임의보행(Second-order Biased Random Walk)`를 사용한다. 
	...
	- 직전 정점의 거리를 기준으로 케이스를 구분하여 차등적인 확률을 부여한다. 
		![image](/assets/posts/2021-02-25-node2vec-556a7ea3.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-96201278.png){:.center}

- `멀어지는 방향`에 높은 확률을 부여한 경우 위와 같은 모습으로 군집이 결정된다. 
- 정점의 역할(bridge, leaf 등)이 같은 경우에 임베딩이 유사하게 된 모습이다.

![image](/assets/posts/2021-02-25-node2vec-74de7987.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-253750a7.png)

**점의 갯수가 많아질 수록 제곱의 크기는 더욱 커지게 된다.** 따라서 많은 경우 근사식을 활용하여 이 문제를 해결한다. 

![image](/assets/posts/2021-02-25-node2vec-1ee7ee52.png)
...
![image](/assets/posts/2021-02-25-node2vec-2fe465fb.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-0af62cb7.png){:.center}
...
- 평점 행렬을 $R$,  사용자의 임베딩 벡터를 쌓아만든 사용자 행렬을 $P$, 영화들의 임베딩 벡터를 쌓아 만든 상품 행렬을 $Q$라고 하자.
	...
	![image](/assets/posts/2021-02-25-node2vec-cdc2d271.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-b0afc8c0.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-7f5f320d.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-9316d307.png){:.center}

영화의 평점이 출시일 이후 시간이 지남에 따라 상승하는 경향을 나타낸 그래프

![image](/assets/posts/2021-02-25-node2vec-e451a143.png){:.center}
...
![image](/assets/posts/2021-02-25-node2vec-9db9435f.png){:.center}
...
- 앙상블 학습
	...
	- bellkor 팀이 처음으로 앙상블하여 처음으로 목표 성능에 도달하였다.
		...
		![image](/assets/posts/2021-02-25-node2vec-ad30ec23.png){:.center}

	- 이에 위기감을 느낀 나머지 팀이 모두 연합하여 team Ensemble을 만들었다. 

		![image](/assets/posts/2021-02-25-node2vec-74e94753.png){:.center}
