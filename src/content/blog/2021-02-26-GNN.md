...
description: "GNN 키워드 줍줍하기"
pubDate: 2021-02-26
slug: "2021-02-26-GNN"
categories: ["BOOSTCAMP"]
tags: ["boostcamp", "recommendation", "gnn"]
disqusId: "https://ydy8989.github.io/2021-02-26-GNN/"
---
...
- 주어진 graph에 대한 모든 정점들에 대하여 대상 정점 별 집계되는 구조를 계산 그래프(Computation graph)라고 부른다.
	...
	![image](/assets/posts/2021-02-26-GNN-73b2cce3.png){:.center}
	
- 이러한 계산 그래프에서의 서로 다른 대상 정점간에도 **Layer에 따른 집계 함수는 공유**한다. 

	![image](/assets/posts/2021-02-26-GNN-0bc1fa87.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-849e5e48.png){:.center}



![image](/assets/posts/2021-02-26-GNN-6e235cfa.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-179d6cad.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-66a9ac20.png){:.center}



**마지막으로** 역전파를 통해 Loss function을 최소화한다. 구체적으로, 역전파를 통해 신경망의 학습 변수들을 학습하게 된다. 

![image](/assets/posts/2021-02-26-GNN-880efc1a.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-983078f3.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-d713082a.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-47387519.png){:.center}
...
![image](/assets/posts/2021-02-26-GNN-00912c33.png){:.center}
