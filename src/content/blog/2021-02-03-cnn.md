...
description: "CNN과 Convolution"
pubDate: 2021-02-03
slug: "2021-02-03-cnn"
categories: ["BOOSTCAMP"]
tags: ["boostcamp"]
disqusId: "https://ydy8989.github.io/2021-02-03-cnn/"
---
...
![image-20210203213902867](/assets/posts/2021-02-03-cnn-59a34309.png){: .center}
...
- why? 
  ...
  ![image-20210203213624646](/assets/posts/2021-02-03-cnn-85a30800.png){: width = "70%"}
...
![image-20210203214007157](/assets/posts/2021-02-03-cnn-1f1ac27e.png){: .center}
...
- How?
  ...
  ![image-20210203214117290](/assets/posts/2021-02-03-cnn-a4ff2a42.png){:.center}
...
- add an identity map(skip connection)
  ...
  ![image-20210203215048189](/assets/posts/2021-02-03-cnn-c3c139e7.png){:.center}
  ![image-20210203215118424](/assets/posts/2021-02-03-cnn-9f3ffe41.png){:.center}
...
- bottleneck architecture
	- ![image-20210203215606937](/assets/posts/2021-02-03-cnn-d212eb0c.png){:.center}

**History of Convolutional Network**

![image-20210203215740181](/assets/posts/2021-02-03-cnn-83367e2a.png)
...
![image-20210203220135858](/assets/posts/2021-02-03-cnn-2440dc1f.png){:width="60%"}{:.center}
...
- 이 때, 단순히 concat을 반복하게 되면 layer가 깊어질수록 아래와 같이 파라미터가 중첩되고, 마지막 층에 가서는 그 수가 기하급수적으로 늘어나게 된다. 
	...
	![image-20210203220541835](/assets/posts/2021-02-03-cnn-1d789738.png)
...
- Dimension reduction
	...
	![image-20210203221419645](/assets/posts/2021-02-03-cnn-5fa01543.png){:.width="80%"}
...
![image-20210203225547769-1612361470642](/assets/posts/2021-02-03-cnn-48efc2d0.png)
...
![image-20210203231020465](/assets/posts/2021-02-03-cnn-5b157e26.png)
...
![image-20210203231923207](/assets/posts/2021-02-03-cnn-873be6a2.png)
...
- 이미지의 모든 픽셀을 분류하는 문제
	...
	![image-20210203171918154](/assets/posts/2021-02-03-cnn-d4c4715e.png)

- Dense classification이라고도 불린다  
- 자율주행에 사용되는 핵심 기술이다. 

    ![](/assets/posts/2021-02-03-cnn-7be7c6f6.gif)
...
- Dense layer
	...
	![image-20210203173834917](/assets/posts/2021-02-03-cnn-6d7e7292.png){: .center}

	> number of param. : 4 X 4 X 16 X 10 = `2,560`

- Fully conv.

	![image-20210203173944524](/assets/posts/2021-02-03-cnn-87456261.png){: .center}
...
![image-20210203182624114](/assets/posts/2021-02-03-cnn-b55d7e54.png){:width="70%"}{: .center}
...
![](/assets/posts/2021-02-03-cnn-0a06d7dd.png)
...
![image-20210203184512116](/assets/posts/2021-02-03-cnn-b22c2cc3.png)
...
![image-20210203185044785](/assets/posts/2021-02-03-cnn-07832936.png)
...
![image-20210203192513937](/assets/posts/2021-02-03-cnn-8ceb4af0.png)

![image-20210203195832312](/assets/posts/2021-02-03-cnn-87a08bd1.png)
...
![image-20210203201634172](/assets/posts/2021-02-03-cnn-584ac4d2.png){: .center}

여기서 `anchor box`는 미리 만들어 놓은 bounding box의 크기이다. 즉, 미리 템플릿을 만들어놓은 후 이 템플릿의 사이즈가 어떻게 바뀔지에 대한 학습을 진행한다. 

![image-20210203202010143](/assets/posts/2021-02-03-cnn-3465e0d4.png)
...
![image-20210203203436584](/assets/posts/2021-02-03-cnn-50c4d1c4.png)
