...
pubDate: 2021-07-11
slug: "2021-07-11-electra"
categories: ["NLP"]
tags: ["nlp", "electra", "machine translation"]
disqusId: "https://ydy8989.github.io/2021-07-11-electra/"
---
...
![image](/assets/posts/2021-07-11-electra-bfc9371f.png)
...
![image](/assets/posts/2021-07-11-electra-58f48e8f.png){:width="80%"}{:.center}
...
![image](/assets/posts/2021-07-11-electra-f33ba7b1.png){:width="80%"}{:.center}
...
| :--: | :----------------------------------------------------------: | :----------------------------------------------------------: |
|  1   | ![image](/assets/posts/2021-07-11-electra-e1eb8f03.png) |          입력 토큰 시퀀스를 <br />받아 임베딩한다.           |
|  2   | ![image](/assets/posts/2021-07-11-electra-74a4edad.png) |                마스킹 후 Generator에 넣는다.                 |
|  3   | ![image](/assets/posts/2021-07-11-electra-cad6ca5b.png) | Original input에서 <br />마스킹 위치를 <br />Generator에서 <br />샘플링한 토큰으로 <br />치환한 뒤 <br />Discriminator에 넣어준다. |
|  4   | ![image](/assets/posts/2021-07-11-electra-e9c36a25.png) | 원본 토큰 시퀀스와 <br />다른지 여부를 <br />모든 토큰에 대하여<br />분류한다. |
...
> ![image](/assets/posts/2021-07-11-electra-dc68c123.png){:.center}
...
![image](/assets/posts/2021-07-11-electra-8fc4d9f6.png){:width="80%"}{:.center}
...
![image](/assets/posts/2021-07-11-electra-c312f2c8.png){:width="80%"}{:.center}
...
![image](/assets/posts/2021-07-11-electra-9b790794.png){:width="80%"}{:.center}
