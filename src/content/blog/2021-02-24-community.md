...
description: "군집탐색(Girvan-Newman / Louvain) & CF basic"
pubDate: 2021-02-24
slug: "2021-02-24-community"
categories: ["BOOSTCAMP"]
tags: ["boostcamp", "recommendation"]
disqusId: "https://ydy8989.github.io/2021-02-24-community/"
---
...
![image](/assets/posts/2021-02-24-community-1395af84.png){:.center}
...
![image](/assets/posts/2021-02-24-community-f7e012bd.png){:.center}
...
- 전체 그래프에서 탐색을 시작하여, 군집들이 서로 분리되도록, `간선들을 순차적으로 제거`한다.
	...
	- 바로 서로 다른 군집간 연결을 해주는 `Bridge(다리)`역할의 간선이다.
		...
		![image](/assets/posts/2021-02-24-community-a2375019.png){:.center}
...
- 그렇다면 서로 다른 군집을 잇는 다리 역할의 간선은 어떻게 찾을까?
	...
	- 이때, 간선 $(x,y)$의 매개 중심성은 다음 수식으로 계산된다.
	    ...
	    ![image](/assets/posts/2021-02-24-community-55590eec.png){:.center}
...
- 간선의 제거 정도에 따라서 다른 `Granularity(입도)`의 군집 구조가 나타난다.
	![image](/assets/posts/2021-02-24-community-5be6ed35.png){:.center}
...
- 그렇다면 간선을 어느정도로 제거해야 적합할까?
	...
	- 현재 time step에서의 connection을 기준으로 군집을 가정한다. 단, 이때마다 각 입력 그래프에서의 군집성(Modularity)을 계산한다.
		...
		![image](/assets/posts/2021-02-24-community-3f14233a.png){:.center}
...
4. 각 군집을 하나의 정점으로하는 군집 레벨의 그래프를 얻은 뒤 `step 3`를 수행한다. 
	![image](/assets/posts/2021-02-24-community-de72c3e5.png){:.center}
...
![image](/assets/posts/2021-02-24-community-c605b830.png){:width="70%"}{:.center}
...
- 그래프에서 직접 연결되지 않은 각 정점 쌍이 (모형에 의해) 직접 연결되지 않을 확률
	![image](/assets/posts/2021-02-24-community-15b4190f.png){:.center}
...
- `중첩 군집 탐색`은 주어진 그래프의 확률을 최대화하는 중첩 군집 모형을 찾는 과정이다. 
	![image](/assets/posts/2021-02-24-community-3a62e5ed.png){:.center}
...
- 즉, 기존 모형에서는 각 정점이 각 군집에 속함 / 안속함 둘중 하나였다면, 이 방식은 어느 그룹에 속할 확률이 얼마인지를 표현할 수 있게 된 것이다. 
	![image](/assets/posts/2021-02-24-community-39bf394a.png){:.center}
...
![image](/assets/posts/2021-02-24-community-d8fe0b81.png){:.center}
...
- 사용자가 선호했던 상품들의 `상품 프로필`을 수집하는 단계
	...
	- 영화의 경우 감독, 장르, 배우 등의 `one-hot-encoding`이 프로필로 사용될 수 있다. 
		...
		![image](/assets/posts/2021-02-24-community-a1b9e5ad.png){:.center}
...
- 사용자 프로필과 상품 프로필을 `매칭`하는 단계
	...
	- 즉, 두 벡터 사이각의 코사인 값을 계산한다. 
		...
		![image](/assets/posts/2021-02-24-community-ae24b9f9.png){:.center}
...
4. 마지막으로 이 상품을 $x$에게 추천한다. 
	...
	![image](/assets/posts/2021-02-24-community-96187ff7.png){:.center}



user-user 협업 필터링의 핵심은 유사한 취향의 사용자를 찾는 것이다. 이때 `취향의 유사도`는 어떻게 계산할까?

![image-20210225180129028](/assets/posts/2021-02-24-community-43c17322.png){:.center}
...
![image](/assets/posts/2021-02-24-community-baeb97b1.png){:.center}
...
![image](/assets/posts/2021-02-24-community-2fe465fb.png){:.center}
