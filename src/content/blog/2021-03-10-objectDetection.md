...
description: "객체 인식 분야의 발전사와 advanced skills"
pubDate: 2021-03-10
slug: "2021-03-10-objectDetection"
categories: ["BOOSTCAMP"]
tags: ["boostcamp"]
disqusId: "https://ydy8989.github.io/2021-03-10-objectDetection/"
---
...
![image](/assets/posts/2021-03-10-objectDetection-47f6a6e2.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-59dea3f8.png){:width="60%"}{:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-639672a2.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-88f65115.png){:.center}
...
- Feature map 상에서 발생할 것 같은 박스들을 미리 정의해둔 후보군을 `Anchor Box`라 한다. 
	...
	![image](/assets/posts/2021-03-10-objectDetection-d41cf39d.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-b5d911c2.png){:width="70%"}{:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-c8c940ea.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-6828d94e.png){:width="70%"}{:.center}

---

지금까지 objective detection의 세 가지 방식을 배웠다. 이 외에도 Mask R-CNN 방식이 있으나 이 포스팅에서는 다루지 않는다. 

![image](/assets/posts/2021-03-10-objectDetection-1cc9516c.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-8c8e4731.png){:.center}

<br>

## You only look once(YOLO)

![image](/assets/posts/2021-03-10-objectDetection-5aee0aaf.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-6dd4c7cd.png){:.center}

YOLO의 아키텍쳐는 일반적인 convolutional neural network와 매우 흡사하다.

![image](/assets/posts/2021-03-10-objectDetection-82467f53.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-8c45ad91.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-0bfccd51.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-f639dd15.png){:.center}
...
- 또한 그림에서 마지막 부분, class마다 8732개의 디텍션이 이루어진다는 의미는 다음의 원리로 계산된다.
	...
	![image](/assets/posts/2021-03-10-objectDetection-102aa278.png){:.center}

- 위와 같이 각 feature map마다 각 픽셀 위치에서 몇 개의 앵커박스가 존재하는지 그 수가 계산된다. 



![image](/assets/posts/2021-03-10-objectDetection-eb2b4453.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-d0d4d452.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-48beca4c.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-bccac5d8.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-5d5bf544.png){:.center}
...
![image](/assets/posts/2021-03-10-objectDetection-09ef7237.png){:.center}
