...
description: "Pandas의 마지막과 확률론"
pubDate: 2021-01-28
slug: "2021-01-28-w2d4"
categories: ["BOOSTCAMP"]
tags: ["boostcamp"]
disqusId: "https://ydy8989.github.io/2021-01-28-w2d4/"
---
...
- ```python
  ...
  > ![image-20210128155107847](/assets/posts/2021-01-28-w2d4-b49291b8.png){: width="45%"}{: .center}![image-20210128155113720](/assets/posts/2021-01-28-w2d4-9648af17.png){: width="45%"}{: .center}
...
- 한 개 이상의 Column을 묶을 수도 있다. 
  ...
  > ![image-20210128155450884](/assets/posts/2021-01-28-w2d4-122855e4.png)
...
- 두 개의 column으로 groupby를 할 경우, index가 두 개 생성된다.
  ...
  > ![image-20210128155947558](/assets/posts/2021-01-28-w2d4-929b43f0.png)

- **unstack()**

  - Group으로 묶여진 데이터를 matrix 형태로 전환해준다. 

    > ![image-20210128160055110](/assets/posts/2021-01-28-w2d4-952f27ca.png)
...
- Groupby에 의해 Split된 상태를 추출할 수 있다. 
  ...
  > ![image-20210128185034495](/assets/posts/2021-01-28-w2d4-8df8af25.png)
...
- 특정 key값을 가진 그룹의 정보만 추출 가능하다.
  ...
  >
  > ![image-20210128185056706](/assets/posts/2021-01-28-w2d4-e5df9627.png)
...
- ```python
  ...
  > ![image-20210128185804544](/assets/posts/2021-01-28-w2d4-fff9ae64.png)
...
- ```python
  ...
  >
  > ![image-20210128190047309](/assets/posts/2021-01-28-w2d4-73557d0c.png)
...
- $$
  ...
  ```
  > ![image-20210128190503913](/assets/posts/2021-01-28-w2d4-3498049e.png)
...
- 특정 조건으로 데이터를 검색할 때 사용한다. 
  ...
  >
  > ![image-20210128191447560](/assets/posts/2021-01-28-w2d4-68eb7766.png)
...
- column에 추가로 labeling 값을 추가하여 value에 numeric type 값을 aggregation하는 형태
  ...
  > ![image-20210128192552712](/assets/posts/2021-01-28-w2d4-b573fe77.png)
  ...
  > ![image-20210128192623488](/assets/posts/2021-01-28-w2d4-1662af4d.png)
...
- User-Item Rating Matrix 등을 만들 때 사용가능함
  ...
  > ![image-20210128192828354](/assets/posts/2021-01-28-w2d4-b85c0c64.png)
  ...
  > ![image-20210128192906252](/assets/posts/2021-01-28-w2d4-0d6b0dea.png)
...
- join method는 총 4가지 방식이 있다. 
  ...
  ![image-20210128203251180](/assets/posts/2021-01-28-w2d4-38234f8b.png)
...
- **Index based join**
  ...
  - 이 경우, 동일 컬럼명이 존재할 시에 `_x`, `_y`가 컬럼명 뒤에 붙는다. (주의)
      ...
      > ![image-20210128203649741](/assets/posts/2021-01-28-w2d4-9b743cf1.png)
...
- 이 때, 데이터는 확률변수 $(\mathbf{x}, y) \sim \mathscr{D}$라고 표기한다.
  ...
  ![image-20210129012427273](/assets/posts/2021-01-28-w2d4-6a1f3b44.png)
...
- $P(\mathbf{x})$는 입력 $\mathbf{x}$에 대한 주변확률분포(marginal probablility distribution)로 $y$에 대한 정보를 주진 않는다. 
  - 단지, 각 x에 대한 y값의 빈도를 계산하여 분포로 나타낸다.
    ![image-20210129014543679](/assets/posts/2021-01-28-w2d4-2d519d5d.png){:width = "45"}{: .center}
