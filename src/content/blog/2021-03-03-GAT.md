...
description: "기본 GNN 이후의 후속 연구들..."
pubDate: 2021-03-03
slug: "2021-03-03-GAT"
categories: ["BOOSTCAMP"]
tags: ["boostcamp", "gnn"]
disqusId: "https://ydy8989.github.io/2021-03-03-GAT/"
---
...
![image](/assets/posts/2021-03-03-GAT-0625d5aa.png){:.center}



마찬가지로 Graph convolutional network에서도 **단순히 연결성을 고려한 가중치로 평균**을 낸다.

![image](/assets/posts/2021-03-03-GAT-84a99967.png){:.center}
...
![image](/assets/posts/2021-03-03-GAT-aff92d77.png){:.center}
...
![image](/assets/posts/2021-03-03-GAT-05df113e.png){:width="60%"}{:.center}



이러한 방식으로 학습된 GAT는 정점 분류의 정확도를 향상시켰다. 

![image](/assets/posts/2021-03-03-GAT-341d4c0b.png){:width="80%"}{:.center}
...
![image](/assets/posts/2021-03-03-GAT-4b33d5f0.png){:.center}
...
![image](/assets/posts/2021-03-03-GAT-0046c525.png){:width="60%"}![image](/assets/posts/2021-03-03-GAT-760c39e1.png){:width="40%"}

이처럼 over-smoothing의 결과로 그래프 신경망의 층 수를 늘렸을 때, 후속 과제(eq. 분류 task)에서의 정확도가 감소하는 현상을 발견했다. 

![image](/assets/posts/2021-03-03-GAT-ebb48d08.png){:width="60%"}{:.center}
...
![image](/assets/posts/2021-03-03-GAT-31b67e57.png){:width="60%"}{:.center}
...
![image](/assets/posts/2021-03-03-GAT-130ae6c1.png){:width="80%"}{:.center}



위의 두 방법 `JK네트워크`와 `APPNP` 모두 성능에 효과가 있는 것으로 나타났고, 특히 **APPNP**의 경우 층의 수가 증가하여도 정확도 감소 효과가 없는 것을 확인하였다고 한다.  

![image](/assets/posts/2021-03-03-GAT-1b5f2c30.png){:.center}
...
![image](/assets/posts/2021-03-03-GAT-65e29a8c.png){:.center}
...
![image](/assets/posts/2021-03-03-GAT-509a3be2.png){:.center}
