...
description: "영상처리는 Resnet 전과 후로 나뉜다."
pubDate: 2021-03-09
slug: "2021-03-09-semantic"
categories: ["BOOSTCAMP"]
tags: ["boostcamp"]
disqusId: "https://ydy8989.github.io/2021-03-09-semantic/"
---
...
![image](/assets/posts/2021-03-09-semantic-2b061db0.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-de187fcb.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-a9575dcb.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-08655bf7.png){:.center}

- resnet18을 기준으로 basicblock들을 생성하고, layer의 갯수는 두배씩 [2,2,2,2]로 준다. 

![image](/assets/posts/2021-03-09-semantic-09efae4d.png){:.center}

- layer는 위와같이 쌓이고, 각각의 layer는 아래와 같이 정의된다. 

![image](/assets/posts/2021-03-09-semantic-f9a69070.png){:.center}

- `_make_layer`라는 함수를 정의하여 파라미터에 따라 쌓이는 규칙을 정의할 수 있게하고, stride는 계속 2로 두어 공간 해상도를 절반씩 줄여간다. 반면에 채널의 사이즈는 두배로 늘어난다. 

![image](/assets/posts/2021-03-09-semantic-6a681258.png){:.center}

- for loop을 통해 블럭을 sequential하게 쌓는다. 
- 이렇게 구성해두면 쉽게 관리할 수 있다.

![image](/assets/posts/2021-03-09-semantic-f03f2728.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-541624db.png){:width="60%"}{:.center}
...
![image](/assets/posts/2021-03-09-semantic-4a213434.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-baac6883.png){:.center}
...
- 그 방식은 `Compound scaling`이라는 방식이며 아래와 같은 구조로 구현된다. 
	...
	![image](/assets/posts/2021-03-09-semantic-11217a49.png){:.center}

- 이 방식을 통해 **효과적**으로 더 좋은 성능의 scaling 방식을 서칭하는데 그 의의가 있다. 

	![image](/assets/posts/2021-03-09-semantic-f3cb877b.png){:.center}
...
- offsets field에 따라서 각각의 weight를 옆으로 벌려주고 이에 맞게끔 activation과 irregular filter를 내적해서 하나의 값으로 도출한다. 
	![image](/assets/posts/2021-03-09-semantic-22eb5c7e.png){:width="70%"}{:.center}
...
- Implemented by **satandard CNN** and grid sampling with **2D offsets**
	...
	![image](/assets/posts/2021-03-09-semantic-9d3d9413.png){:width="70%"}{:.center}
...
![image](/assets/posts/2021-03-09-semantic-56d9fd73.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-a1afe58e.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-1d62871d.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-b0bc5711.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-b276b045.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-0a3c9cf3.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-9bd57b65.png){:.center}

- 하지만 위와 같은 방식으로 연산을 진행할때 $az + bx$와 같이 중첩이 생기는 부분이 발생한다.
- 이부분을 신경써서 튜닝을 해줘야한다. 

![image](/assets/posts/2021-03-09-semantic-a5c41298.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-b06942a1.png){:.center}
...
- Captures lower-level semantics at the same time
 ...
 ![image](/assets/posts/2021-03-09-semantic-7d74f50b.png){:.center}

- 위 그림과 같이 중간 단계의 특징들을 합칠수록 큰 도움이 된다는 것을 확인할 수 있다. 

![image](/assets/posts/2021-03-09-semantic-91fc7e95.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-5ef8e98f.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-dc602b1b.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-c2ca85a0.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-50f9b8f0.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-20d8a180.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-4cca61d3.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-de34a1c0.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-f7ca2978.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-670811c9.png){:.center}
...
![](/assets/posts/2021-03-09-semantic-f2c6e14a.gif){:width="50%"}{:.center}

아래는 이러한 Dilated convolution을 잘 표현한 이미지이다. 

![image](/assets/posts/2021-03-09-semantic-f363719c.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-33958a5a.png){:.center}
...
![image](/assets/posts/2021-03-09-semantic-cdce7a2a.png){:.center}
