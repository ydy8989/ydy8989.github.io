...
description: "그래프 구조의 이해와 중요성"
pubDate: 2021-02-22
slug: "2021-02-22-graph1"
categories: ["BOOSTCAMP"]
tags: ["boostcamp", "graph"]
disqusId: "https://ydy8989.github.io/2021-02-22-graph1/"
---
...
![image](/assets/posts/2021-02-22-graph1-ccda9ff7.png){:.center}
...
![image](/assets/posts/2021-02-22-graph1-5c104325.png){:width="33%"}![image](/assets/posts/2021-02-22-graph1-9bbcf17f.png){:width="33%"}![image](/assets/posts/2021-02-22-graph1-f79912dd.png){:width="33%"}

![image](/assets/posts/2021-02-22-graph1-2219b87c.png){:width="33%"}![image](/assets/posts/2021-02-22-graph1-5362b7f8.png){:width="33%"}![image](/assets/posts/2021-02-22-graph1-62b793a2.png){:width="33%"}
...
![image](/assets/posts/2021-02-22-graph1-b9eb108a.png){:.center}

**그래프 초기화**

![image](/assets/posts/2021-02-22-graph1-4c8a6963.png){:.center}

**Vertex 추가, 카운트 그리고 목록 반환**

![image](/assets/posts/2021-02-22-graph1-b4817872.png){:.center}

**더 많은 vertex 추가**

![image](/assets/posts/2021-02-22-graph1-ca6ce1d5.png){:.center}

**Edge 추가하고 목록 반환**

![image](/assets/posts/2021-02-22-graph1-ad6f6003.png){:.center}

**더 많은 edge 추가**

![image](/assets/posts/2021-02-22-graph1-42f54c36.png){:.center}

**그래프 시각화**

![image](/assets/posts/2021-02-22-graph1-f93dfed1.png){:width="66%"}![image](/assets/posts/2021-02-22-graph1-988d12c2.png){:width="33%"}
...
![image](/assets/posts/2021-02-22-graph1-b285d737.png){:width="60%"}{:.center}
...
![image](/assets/posts/2021-02-22-graph1-f3bff66d.png){:.center}
...
![image](/assets/posts/2021-02-22-graph1-7b01b44d.png){:.center}

결과적으로 25%의 편지만 도착했고, 평균적으로 6단계만을 거쳤다. 

![image](/assets/posts/2021-02-22-graph1-17c32a7c.png){:.center}



비슷한 실험으로, MSN 메신저에서 정점간 평균 거리는 7정도 밖에 되지 않았다. (단, `거대 연결 구조`만을 고려했다. 이는 뒤에서 설명하도록 한다.)

![image](/assets/posts/2021-02-22-graph1-564cc264.png){:.center}
...
![image](/assets/posts/2021-02-22-graph1-1ece9748.png){:.center}
...
![image](/assets/posts/2021-02-22-graph1-93049ef8.png){:width="80%"}{:.center}
...
![image](/assets/posts/2021-02-22-graph1-1055dfd5.png){:.center}
...
![image](/assets/posts/2021-02-22-graph1-7620f1c6.png){:width="70%"}{:.center}
...
1. **동질성(homophily)** : 서로 유사한 정점끼리 간선으로 연결될 가능성이 높다.
	...
	![image](/assets/posts/2021-02-22-graph1-3e69ad43.png){:width="60%"}{:.center}

2. **전이성(Transitivity)** : 공통 Neighbor가 있는 경우, 해당 Neighbor가 매개 역할을 해줄 수 있다. 

	![image](/assets/posts/2021-02-22-graph1-3c1bae8c.png){:.center}
