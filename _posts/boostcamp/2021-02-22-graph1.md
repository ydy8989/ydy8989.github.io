...
![image](https://user-images.githubusercontent.com/38639633/108645523-78a83b00-74f6-11eb-8a8c-9fde280b469a.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108650318-a5624f80-7502-11eb-9724-333d97f526e3.png){:.center}

**그래프 초기화**

![image](https://user-images.githubusercontent.com/38639633/108650322-a6937c80-7502-11eb-85a1-5f7c326d816f.png){:.center}

**Vertex 추가, 카운트 그리고 목록 반환**

![image](https://user-images.githubusercontent.com/38639633/108650325-a85d4000-7502-11eb-9e71-090a9ac1ae67.png){:.center}

**더 많은 vertex 추가**

![image](https://user-images.githubusercontent.com/38639633/108650327-a98e6d00-7502-11eb-9e9a-27d6b3677061.png){:.center}

**Edge 추가하고 목록 반환**

![image](https://user-images.githubusercontent.com/38639633/108650331-ab583080-7502-11eb-9d36-ffd15921c64d.png){:.center}

**더 많은 edge 추가**

![image](https://user-images.githubusercontent.com/38639633/108650333-ad21f400-7502-11eb-8466-7cb14edf281e.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108653644-57514a00-750a-11eb-8d88-e076eda5fb8e.png){:width="60%"}{:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108667928-83c29180-751d-11eb-879a-413993c800b4.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108669251-fc2a5200-751f-11eb-9e9e-5fbe979b4162.png){:.center}

결과적으로 25%의 편지만 도착했고, 평균적으로 6단계만을 거쳤다. 

![image](https://user-images.githubusercontent.com/38639633/108669304-16643000-7520-11eb-948e-1868b42e342f.png){:.center}



비슷한 실험으로, MSN 메신저에서 정점간 평균 거리는 7정도 밖에 되지 않았다. (단, `거대 연결 구조`만을 고려했다. 이는 뒤에서 설명하도록 한다.)

![image](https://user-images.githubusercontent.com/38639633/108669373-41e71a80-7520-11eb-8324-cfe506ab27d1.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108689176-1a05b000-753c-11eb-9eb6-36f686543caa.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108690482-c300da80-753d-11eb-98d4-9030e8dc28a6.png){:width="80%"}{:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108690886-36a2e780-753e-11eb-9b41-79cdfaff8fcf.png){:.center}
...
![image](https://user-images.githubusercontent.com/38639633/108691518-f09a5380-753e-11eb-840e-305ab73fd68e.png){:width="70%"}{:.center}
...
- 예)
	- ![image](https://user-images.githubusercontent.com/38639633/108691746-2c351d80-753f-11eb-85f6-bbce2084d222.png){:.center}
	- 정점 1의 이웃은 4개이며, 총 6개의 이웃 쌍$((2,3),(2,4),(2,5),(3,4),(3,5),(4,5))$이 존재한다. 그 중 3개의 쌍$((2,4),(2,3),(3,5))$이 간선으로 직접 연결되어있다. 따라서 $C_1=\frac{3}{6}=0.5$이다. 
	- ![image](https://user-images.githubusercontent.com/38639633/108691925-5d155280-753f-11eb-93a2-a863e15bcd5d.png){:.center}
...
1. **동질성(homophily)** : 서로 유사한 정점끼리 간선으로 연결될 가능성이 높다.
	...
	![image](https://user-images.githubusercontent.com/38639633/108700187-95219300-7549-11eb-915d-a5603c076599.png){:width="60%"}{:.center}

2. **전이성(Transitivity)** : 공통 Neighbor가 있는 경우, 해당 Neighbor가 매개 역할을 해줄 수 있다. 

	![image](https://user-images.githubusercontent.com/38639633/108706190-96ef5480-7551-11eb-8515-346e3b8065e0.png){:.center}
